...
wp_enqueue_style( 'csf-semanticui', 'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/fomantic-ui/2.8.8/semantic.min.css', array(), '2.9.2', 'all' );
      // Font awesome 4 and 5 loader
      if ( apply_filters( 'csf_fa4', false ) ) {
        wp_enqueue_style( 'csf-fa', 'https://lf6-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.7.0', 'all' );
      } else {
        wp_enqueue_style( 'csf-fa5', 'https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/all.min.css', array(), '5.15.5', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', 'https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/v4-shims.min.css', array(), '5.15.5', 'all' );
      }
      ...
      wp_enqueue_script( 'csf', self::include_plugin_url( 'assets/js/main'. $min .'.js' ), array( 'csf-plugins' ), self::$version, true );
       ...
       wp_enqueue_script( 'csf-backend', self::include_plugin_url( 'assets/js/backend.js' ), array(), self::$version, true );
