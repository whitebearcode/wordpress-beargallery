...
wp_enqueue_style( 'csf-semanticui', 'https://cdn.staticfile.net/fomantic-ui/2.9.3/semantic.min.css', array(), '2.9.2', 'all' );
      // Font awesome 4 and 5 loader
      if ( apply_filters( 'csf_fa4', false ) ) {
        wp_enqueue_style( 'csf-fa', 'https://cdn.staticfile.net/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.7.0', 'all' );
      } else {
        wp_enqueue_style( 'csf-fa5', 'https://cdn.staticfile.net/font-awesome/5.15.4/css/all.min.css', array(), '5.15.5', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', 'https://cdn.staticfile.net/font-awesome/5.15.4/css/v4-shims.min.css', array(), '5.15.5', 'all' );
      }
