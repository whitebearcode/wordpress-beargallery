						...
						<div class="bgallery_fl_gallery_list">
							...
							<div class="bgallery_fl_gallery_list_in">
								<div class="title_holder">
									<h2><a href="<?php the_permalink() ?>"><span class="bgallery_post_title"><?php the_title(); ?></span></a></h2>
...
?></span>
            ...
            ?>
								    <?php echo General::getArticleImage(apply_filters('the_content', $content),get_the_ID(),'nosingle');?>
									
								</ul>
								<span class="see_more"><a href="<?php the_permalink() ?>">查看更多</a></span>
							</div>
						<?php endwhile; ?>
	<span class="prev_g">
<?php previous_posts_link('上一页'); ?></span>  <span class="next_g"><?php next_posts_link('下一页'); ?></span>
